  ...
  return (
    <div>
      ...
      <form onSubmit={handleAddItem} className="mb-6">
        ...
        <button 
          type="submit"
          className="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 transition-colors"
        >
          Add Item
        </button>
      </form>
        ...
        <>
          ...
          <ul className="mb-6 space-y-2">
            {state.items.map(item => (
              <li key={item.id} className="flex justify-between items-center p-2 bg-zinc-50 rounded-md border border-zinc-200 shadow-sm">
                <div>
      ...
      <div className="flex justify-between">
        ...
        <button
          onClick={handleNext}
          className={`bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 transition-colors ${state.items.length === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
