import { useCallback, useRef, memo, useState, type FormEvent } from 'react';
...
const PersonInputForm = memo(({ onAddPerson }: PersonInputFormProps) => {
...
const PeopleList = memo(({ people, onRemove, onEdit }: PeopleListProps) => {
