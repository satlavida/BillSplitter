            ...
            return (
              <button
                ...
                className={`
                  ...
                  h-24 transition-all ${
                    isCompleted 
                      ? `opacity-50 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'}` 
                      : `${theme === 'dark' 
              ...
              >
                ...
                <div className={`
                  ...
                  ${isCompleted 
                    ...
                    : `${theme === 'dark' ? 'bg-blue-500' : 'bg-blue-500 text-white'}`}
                `}>
                ...
                {isCompleted && (
                  <span className={`text-xs mt-1 ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`}>
                    ✓ Completed
                  </span>
                )}
              </button>
